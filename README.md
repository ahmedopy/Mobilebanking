...
- **Bill Payments** - Gas, electricity, WiFi with cashback
- **Bill Splitting** - Split bills across multiple accounts
- **Installment Payments** - Pay bills in installments
- **Micro-Loans** - Small loans with flexible repayment
- **Money Requests** - Request from other users
- **Admin Panel** - Undo transactions, suspend accounts, approve registrations
- **FAQ Chatbot** - AI-powered support
